    ...
    <div class="col-xl-3 col-sm-6">
      <div class="card">
        <div class="card-header pb-3">
          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-users icon-md"></i> Manufacturers</h5>
          <h4 class="mb-0"><?php echo e($manufacturers); ?></h4>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-sm-6">
      <div class="card">
        <div class="card-header pb-3">
          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-users icon-md"></i> Modifiers</h5>
          <h4 class="mb-0"><?php echo e($modifiers); ?></h4>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-sm-6">
      <div class="card">
        <div class="card-header pb-3">
          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-users icon-md"></i> Distributers</h5>
          <h4 class="mb-0"><?php echo e($distributers); ?></h4>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-sm-6">
      <div class="card">
        <div class="card-header pb-3">
          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-users icon-md"></i> Customers</h5>
          <h4 class="mb-0"><?php echo e($users); ?></h4>
        </div>
      </div>
    </div>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center"> <img
                                src="<?php echo e(asset('public/admin/img/illustrations/card-website-analytics-1.png')); ?>"
          ...
          <div class="swiper-slide">
            <div class="row">
              ...
              <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center"> <img
                              src="<?php echo e(asset('public/admin/img/illustrations/card-website-analytics-2.png')); ?>"
                              alt="Website Analytics"
                              height="150"
                              class="card-website-analytics-img" /> </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="row">
              ...
              <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center"> <img
                              src="<?php echo e(asset('public/admin/img/illustrations/card-website-analytics-3.png')); ?>"
                              alt="Website Analytics"
                              height="150"
                              class="card-website-analytics-img" /> </div>
            </div>
        ...
        <div class="card-header pb-0 d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button
                          ...
                          aria-haspopup="true"
                          aria-expanded="false"> <i class="icon-base ti tabler-dots-vertical icon-md text-body-secondary"></i> </button>
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="earningReportsId"> <a class="dropdown-item" href="javascript:void(0);">View More</a> <a class="dropdown-item" href="javascript:void(0);">Delete</a> </div>
          </div>
        </div>
        <div class="card-body">
          <div class="row align-items-center g-md-8">
            <div class="col-12 col-md-5 d-flex flex-column">
              ...
              <small class="text-body">You informed of this week compared to last week</small> </div>
        ...
        <div class="card-header d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button
                          ...
                          aria-haspopup="true"
                          aria-expanded="false"> <i class="icon-base ti tabler-dots-vertical icon-md text-body-secondary"></i> </button>
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="supportTrackerMenu"> <a class="dropdown-item" href="javascript:void(0);">View More</a> <a class="dropdown-item" href="javascript:void(0);">Delete</a> </div>
          </div>
        </div>
            ...
            <ul class="p-0 m-0">
              ...
              <li class="d-flex gap-4 align-items-center pb-1">
                ...
                <div>
                  ...
                  <small class="text-body-secondary">1 Day</small> </div>
              </li>
            </ul>
          </div>
        ...
        <div class="card-header d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button
                          ...
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"> <i class="icon-base ti tabler-dots-vertical icon-22px text-body-secondary"></i> </button>
...
<?php echo $__env->make('layout.admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ofb9u7na3r4v/public_html/demo.kaushalenterprises.co.in/webd/resources/views//panel/dashboard.blade.php ENDPATH**/ ?>