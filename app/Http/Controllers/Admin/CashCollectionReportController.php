...
class CashCollectionReportController extends Controller {
    ...
    public function getList(Request $request){
		...
		return view('/panel/cash_collection_report/index',compact('PREV','products','payment_methods'));
    }
    ...
    public function listPaginate(Request $request){
        ...
        return view('/panel/cash_collection_report/paginate', compact('records','PREV','sum_investment_amount','sum_reg_fee'));
    }
