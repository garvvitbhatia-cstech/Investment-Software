...
class BouncedCollectionReportController extends Controller {
    ...
    public function getList(Request $request){
		...
		return view('/panel/bounced_collection_report/index',compact('PREV','products','payment_methods'));
    }
    ...
    public function listPaginate(Request $request){
		...
		if(!empty($request->input('from_date')) || !empty($request->input('to_date'))){
			...
			$query->where('mel_investment.bounced_date' , '>=', $from_date);
			$query->where('mel_investment.bounced_date' , '<=', $to_date);
		}
        ...
        return view('/panel/bounced_collection_report/paginate', compact('records','PREV','sum_investment_amount','sum_reg_fee'));
    }
