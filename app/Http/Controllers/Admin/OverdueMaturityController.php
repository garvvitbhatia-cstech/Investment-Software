...
class OverdueMaturityController extends Controller {
    ...
    public function getList(Request $request){
		...
		return view('/panel/overdue_maturity_report/index',compact('PREV','products','payment_methods','payee_bank'));
    }
    ...
    public function listPaginate(Request $request){
		...
		if(!empty($request->input('from_date')) || !empty($request->input('to_date'))){
			...
			$mdate = date('Y-m-d');
			$query->where('mel_investment.maturity_date' , '<', $mdate);
		}
		...
		$sum = $records->sum('maturity_val');
        return view('/panel/overdue_maturity_report/paginate', compact('records','PREV'));
    }
