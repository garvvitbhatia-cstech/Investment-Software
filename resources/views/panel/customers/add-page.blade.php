                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    <div class="row g-2">                      
                      <div class="col-md-4">
                        ...
                        <input type="text" id="udaid" name="udaid" value="" class="form-control numberonly"/>
                      </div>
                      <div class="col-md-4">
                        <label class="form-label required" for="title">Employee Code</label>
                        <input type="text" id="emp_code" name="emp_code" value="" class="form-control"/>
                      </div>
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" id="cust_name" name="cust_name" value="" class="form-control"/>
                      </div>
                      <div class="col-md-4">
                        <label class="form-label" for="title">PAN</label>
                        <input type="text" id="pan_no" name="pan_no" maxlength="10" value="" class="form-control"/>
                      </div>
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" id="gurdain_name" name="gurdain_name" value="" class="form-control"/>
                      </div>
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" id="contact_no" name="contact_no" maxlength="10" value="" class="form-control numberonly"/>
                      </div>
                      <div class="col-md-4">
                        <label class="form-label" for="title">Contact No.(Alter)</label>
                        <input type="text" id="alt_contact_no" maxlength="10" name="alt_contact_no" value="" class="form-control numberonly"/>
                      </div>
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="date" id="doa" name="doa" value="" class="form-control"/>
                      </div>
                      @if($PREV == 1 || $PREV == 3)
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" id="zip_code" maxlength="6" name="zip_code" value="" class="form-control numberonly"/>
                      </div>
                    </div>
                  </div>                   
                  <div class="pt-6">
...
var addUrl = "{{route('admin.add-customer')}}";
$(document).ready(function(){
				...
				var obj = JSON.parse(response);
				 if(obj['heading'] == "Success"){					
					swal("", obj['msg'], "success").then((value) => {
						window.location.href = "{{url('/panel/edit-customer/')}}/"+obj['row_id'];
					});
				}else{
