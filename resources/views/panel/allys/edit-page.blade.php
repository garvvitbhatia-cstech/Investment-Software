                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    ...
                    <div class="row g-2">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" id="ally_person_name" name="ally_person_name" value="{{$record->ally_person_name}}" class="form-control" />
                      ...
                      <div class="col-md-3">
                        ...
                        <select name="branch" id="branch" class="form-select">
                            ...
                            @foreach($branches as $key => $branch)
                                ...
                                <option {{$branch->id == $record->branch?'selected':''}} data-bcode="{{ $branch->branch_code }}" value="{{$branch->id}}">{{$branch->branch_name}}</option>
                      ...
                      <div class="col-md-3">
                        ...
                        <select name="ally_type" id="ally_type" class="form-select">
                            ...
                            @foreach($ally_types as $key => $type)
                                ...
                                <option {{$type->id == $record->ally_type?'selected':''}} data-fee="{{ $type->ally_fees }}" data-acode="{{ $type->ally_code }}" value="{{$type->id}}">{{$type->ally_type}}</option>
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" id="registration_fees" name="registration_fees" value="{{number_format($record->registration_fees,2)}}" class="form-control" />
                      ...
                      <div class="col-md-3">
                        ...
                        <select name="payment_status" id="payment_status" class="form-select">
                        	...
                        	<option {{$record->payment_status == 0?'selected':''}} value="0">Pending</option>
                            
                            <option {{$record->payment_status == 1?'selected':''}} value="1">Paid</option>
...
var addUrl = "{{url('/panel/edit-ally/')}}/{{$record->id}}";
