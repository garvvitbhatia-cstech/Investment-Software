...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form id="searchForm" name="searchForm">
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          ...
          <input type="text" class="form-control" name="search_keywords" placeholder="Search by Person Name" id="defaultFormControlInput" />

        </div>
        
        <div class="col-md-2">

          <input type="text" class="form-control" name="ally_code" placeholder="Search by Ally Code" id="defaultFormControlInput" />

        </div>
        
        <div class="col-md-2">
        
        	<select name="search_payment_status" id="search_payment_status" class="form-select">
  ...
  <div class="card">
    ...
    <h5 class="card-header">Ally <a href="{{route('admin.add-ally')}}" style="float:right; color:#FFF" class="btn btn-success waves-effect waves-light">Add</a></h5>
