                ...
                <div class="tab-content p-0">
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    <div class="row g-2">
                      ...
                      <div class="col-md-4">
                        <label class="form-label required" for="title">Branch Code</label>
                        <input type="text" id="branch_code" name="branch_code" class="form-control" value="{{$record->branch_code}}" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.branches')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{url('/panel/edit-branch/')}}/{{$record->id}}";
$(document).ready(function(){
