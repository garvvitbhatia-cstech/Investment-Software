@if($records->count()>0)
    ...
    <td>{{GetDetails('master_branch',$row->branch_id,'branch_name')}}</td>
    ...
    <a class="dropdown-item" style="cursor:pointer" href="{{url('panel/edit-branch-admin',base64_encode($row->id))}}"><i class="icon-base ti tabler-pencil me-1"></i> Edit</a>
