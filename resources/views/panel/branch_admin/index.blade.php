...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <h5 class="card-header">Branch Admin <a href="{{route('admin.add-branch-admin')}}" style="float:right; color:#FFF" class="btn btn-success waves-effect waves-light">Add</a></h5>
...
<script type="text/javascript">
    ...
    function filterData(type = null){
        ...
        $.ajax({
            ...
            url: "{{ url('/panel/branch_admin_paginate') }}",
