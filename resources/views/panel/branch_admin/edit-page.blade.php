...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <h6 class="mt-6">Edit Branch Admin</h6>
                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    ...
                    <div class="row g-2">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" id="mobile" name="mobile" maxlength="10" value="{{$record->mobile}}" class="form-control numberonly" />
                      ...
                      <div class="col-md-3">
                        ...
                        <select name="branch_id" id="branch_id" class="form-select">
                            ...
                            @foreach($branches as $key => $branch)
                            	...
                            	<option {{$branch->id == $record->branch_id?'selected':''}} value="{{$branch->id}}">{{$branch->branch_name}}</option>
...
var addUrl = "{{url('/panel/edit-branch-admin/')}}/{{$record->id}}";
