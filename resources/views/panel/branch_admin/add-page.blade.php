...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <h6 class="mt-6">Add Branch Admin</h6>
                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    ...
                    <div class="row g-2">
                      ...
                      <div class="col-md-3">
                        ...
                        <label class="form-label required" for="title">Mobile</label>

                        <input type="text" id="mobile" name="mobile" maxlength="10" class="form-control numberonly" />
                      ...
                      <div class="col-md-3">
                        ...
                        <label class="form-label required" for="title">Branch Name</label>
                      ...
                      <div class="col-md-3">
                        ...
                        <label class="form-label required" for="title">Confirm Password</label>
          ...
          <div class="card mb-6">
            ...
            <div class="card-body">
              ...
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.branch-admin')}}'" class="btn btn-label-secondary" >Cancel</button>
...
var addUrl = "{{route('admin.add-branch-admin')}}";
				...
				var obj = JSON.parse(response);
				 ...
				 if(obj['heading'] == "Success"){					
					...
					swal("", obj['msg'], "success").then((value) => {
						...
						window.location.href = "{{url('/panel/edit-branch-admin/')}}/"+obj['row_id'];
