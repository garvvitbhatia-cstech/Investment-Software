...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <h5 class="card-header">Admins <a href="{{route('admin.add-admin')}}" style="float:right; color:#FFF" class="btn btn-success waves-effect waves-light">Add</a></h5>
