...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <h5 class="card-header">Products <a href="{{route('admin.add-product')}}" style="float:right; color:#FFF" class="btn btn-success waves-effect waves-light">Add</a></h5>
      ...
      <table class="table">
        ...
        <thead>
          ...
          <tr>
            ...
            <th>Registration Fee Per Unit</th>
...
<script type="text/javascript">
	...
	function filterData(type = null){
		...
		$.ajax({
			...
			url: "{{ url('/panel/products_paginate') }}",
