                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    <div class="row g-2">
                      <div class="col-md-6">
                        ...
                        <input type="text" id="product_name" name="title" value="{{$record->title}}" class="form-control" />
                      </div>
                      <div class="col-md-3">
                        <label class="form-label required" for="title">Date</label>
                        <input type="date" id="holiday_date" name="holiday_date" value="{{$record->holiday_date}}" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.holidays')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{url('/panel/edit-holiday/')}}/{{$record->id}}";
