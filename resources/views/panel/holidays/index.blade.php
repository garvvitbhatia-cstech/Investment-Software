...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card mb-2 p-3">
    <form id="searchForm" name="searchForm">
      <div class="row">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="search_title" placeholder="Search by Title" id="defaultFormControlInput" />
        </div>
  ...
  <div class="card">
    <h5 class="card-header">Holidays <a href="{{route('admin.add-holiday')}}" style="float:right; color:#FFF" class="btn btn-success waves-effect waves-light">Add</a></h5>
...
<script type="text/javascript">
	...
	function filterData(type = null){
		...
		$.ajax({
			...
			url: "{{ url('/panel/holidays_paginate') }}",
